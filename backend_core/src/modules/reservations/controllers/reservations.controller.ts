...
import { mesasService } from '@modules/tables/services/mesas.service'; 
...
export const reservationsController = {
  ...
  */
  async createReservation(req: Request, res: Response) : Promise<any> {
    try {
   ...
   */
  async getAvailableMesas(req: Request, res: Response) : Promise<any> {
      try {
          const tenant = (req as RequestWithTenant).tenant;
  ...
  async getReservations(req: AuthRequest, res: Response) : Promise<any> {
    try {
  ...
  async updateReservationStatus(req: AuthRequest, res: Response) : Promise<any> {
    try {
      const tenantId = req.user?.tenant_id;
