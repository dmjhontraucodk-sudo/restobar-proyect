...
export const rolesController = {
     ...
     */
    async createRol(req: AuthRequest, res: Response) : Promise<any> {
        try {
            const usuarioActual = await rolesService.getEmpleadoById(req.user!.id);
     ...
     */
    async updateRol(req: AuthRequest, res: Response) : Promise<any> {
        try {
            const usuarioActual = await rolesService.getEmpleadoById(req.user!.id);
     ...
     */
    async desactivarRol(req: AuthRequest, res: Response) : Promise<any> {
        try {
            const usuarioActual = await rolesService.getEmpleadoById(req.user!.id);
            const rolId = parseInt(req.params.id);
     ...
     */
    async activarRol(req: AuthRequest, res: Response) : Promise<any> {
        try {
            const usuarioActual = await rolesService.getEmpleadoById(req.user!.id);
            const rolId = parseInt(req.params.id);
