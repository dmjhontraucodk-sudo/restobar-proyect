...
export const sendRegistrationEmail = async (userEmail: string, userName: string): Promise<any> => {
  try {
...
export const sendOrderConfirmation = async (order: any, tenantConfig: any): Promise<any> => {
...
export const sendOrderCancellation = async (order: any, tenantConfig: any, reason: string = ''): Promise<any> => {
...
export const sendOrderReady = async (order: any, tenantConfig: any): Promise<any> => {
...
export const sendReservationConfirmation = async (reservation: any): Promise<any> => {
...
export const sendReservationCancellation = async (reservation: any): Promise<any> => {
