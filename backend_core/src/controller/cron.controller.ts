...
export const cronController = {
   ...
   */
  async ejecutarResumenDiario(req: AuthRequest, res: Response) {
    try {
   ...
   */
  async verificarStockBajoManual(req: AuthRequest, res: Response) {
    try {
      const tenantId = req.user?.tenant_id;
      ...
      const productos = await inventoryAlertsService.verificarStockBajo(tenantId);
   ...
   */
  async getEstadoCronJobs(req: AuthRequest, res: Response) {
    try {
      const tenantId = req.user?.tenant_id;
