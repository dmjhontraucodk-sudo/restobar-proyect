...
exports.notificationService = {
     ...
     */
    obtenerEmailDestino(config, tipo) {
     ...
     */
    async notificarNuevoPedidoWeb(tenantId, pedido) {
        try {
     ...
     */
    async notificarProductoAgotado(tenantId, producto) {
        try {
            const config = await tenant_config_service_1.tenantConfigService.getConfig(tenantId);
     ...
     */
    async notificarStockBajo(tenantId, productos) {
        try {
            const config = await tenant_config_service_1.tenantConfigService.getConfig(tenantId);
     ...
     */
    async enviarResumenDiario(tenantId, estadisticas) {
        try {
            const config = await tenant_config_service_1.tenantConfigService.getConfig(tenantId);
