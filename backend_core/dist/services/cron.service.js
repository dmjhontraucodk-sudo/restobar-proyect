...
const inventory_alerts_service_1 = require("./inventory-alerts.service");
exports.cronService = {
    /**
    ...
    async verificarResumenDiario() {
        try {
            ...
            const tenantsConResumen = await prisma_1.prisma.tenant_config.findMany({
                where: {
            ...
            for (const config of tenantsConResumen) {
                ...
                const tenant = await prisma_1.prisma.tenants.findUnique({
    ...
    async verificarStockBajoTodosTenants() {
        try {
            ...
            const tenantsConAlertas = await prisma_1.prisma.tenant_config.findMany({
                where: {
