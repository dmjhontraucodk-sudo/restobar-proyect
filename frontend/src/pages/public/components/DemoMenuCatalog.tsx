// src/pages/public/components/DemoMenuCatalog.tsx
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            {tenantInfo?.nombre_empresa || 'Menú Demo'}
          </h2>
          <p className="text-gray-600 text-lg">Esta es una demostración interactiva</p>
        </div>
        ...
        <div className="fixed bottom-6 right-6 z-50">
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold p-4 rounded-full shadow-2xl transition-all transform hover:scale-110 flex items-center gap-2"
          >
            <ShoppingBag size={24} />
            {cartItemCount > 0 && (
...
function ProductCard({ product, onAddToCart }: { product: Producto; onAddToCart: (product: Producto) => void }) {
  return (
    <div className="group bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-blue-500/50 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10">
      {/* Imagen del Producto */}
