...
const TeamManagementPage: React.FC = () => {
  ...
  const [editingEmpleado, setEditingEmpleado] = useState<ApiEmpleado | null>(
    null
  );
  ...
  const [selectedEmployeeIncidencia, setSelectedEmployeeIncidencia] =
    useState<ApiEmpleado | null>(null);
  ...
  const handleConfirmIncidencia = async (data: {
    id: number;
    monto: number;
    motivo: string;
    es_adelanto: boolean;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Administra empleados y roles de tu restaurante.
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 flex flex-col lg:flex-row justify-between items-center gap-4">
                  <span className="text-sm text-gray-500">
                    {empleados.length} miembros en total
                  </span>
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() => reloadEmpleados()}
                      className="flex items-center gap-2 px-4 py-2 bg-white border rounded-xl hover:bg-gray-50 text-gray-700"
                    >
                      <RefreshIcon className="w-4 h-4" /> Actualizar
                    </button>
                    <button
                      onClick={handleOpenCreateModal}
                      className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-medium shadow-sm"
                    >
