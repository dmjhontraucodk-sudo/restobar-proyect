...
import { useMesas } from '@features/tables/model/useMesas';
import { type ApiMesa } from '@shared/types';
import { TableIcon, UsersIcon, PlusIcon, EditIcon, TrashIcon, RefreshIcon, QrcodeIcon } from '@shared/ui/Icons';
