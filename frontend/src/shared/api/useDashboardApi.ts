...
import {
  ...
  type CerrarCajaData,
  type CalcularPagoResponse, // Importado
  type PagarNominaData, // Importado
...
export const useDashboardApi = () => {
  ...
  const getProducts = useCallback(
    (tipo: TipoCategoria): Promise<ApiProduct[]> => {
      return makeRequest<ApiProduct[]>(`/catalog/products?tipo=${tipo}`);
    },
    [makeRequest]
  );
  ...
  const createProductWithRecipe = useCallback(
    (productData: CreateProductData): Promise<ApiProduct> => {
      return makeRequest<ApiProduct>("/catalog/products", {
        method: "POST",
  ...
  const updateProduct = useCallback(
    (
      ...
      return makeRequest<ApiProduct>(`/catalog/products/${productId}`, {
        method: "PATCH",
  ...
  const getProductById = useCallback(
    (productId: number | string): Promise<ApiProductWithRecipe> => {
      return makeRequest<ApiProductWithRecipe>(`/catalog/products/${productId}`);
    },
    [makeRequest]
  );
  ...
  const getCategories = useCallback(
    (tipo: TipoCategoria): Promise<ApiCategory[]> => {
      return makeRequest<ApiCategory[]>(`/catalog/categories?tipo=${tipo}`);
    },
    [makeRequest]
  );
  ...
  const updateOrdenEstado = useCallback(
    (ordenId: number, estado: OrdenEstado): Promise<{ message: string }> => {
      return makeRequest<{ message: string }>(`/orders/${ordenId}/estado`, {
        method: "PATCH",
  ...
  const getMesasConOrdenes = useCallback((): Promise<ApiMesa[]> => {
    return makeRequest<ApiMesa[]>("/orders/mesas");
  }, [makeRequest]);
  ...
  const getCategoriasInventario = useCallback((): Promise<
    CategoriaInventario[]
  > => {
    return makeRequest<CategoriaInventario[]>("/inventory/categorias");
  }, [makeRequest]);
  ...
  const updateCategoriaInventario = useCallback(
    (
      ...
      return makeRequest<CategoriaInventario>(`/inventory/categorias/${id}`, {
        method: "PUT",
        body: JSON.stringify(data),
      });
    },
  ...
  const getTiposGasto = useCallback((): Promise<TipoGasto[]> => {
    return makeRequest<TipoGasto[]>("/finance/tipos-gasto");
  }, [makeRequest]);
  ...
  const getUnidadesMedida = useCallback((): Promise<UnidadMedida[]> => {
    return makeRequest<UnidadMedida[]>("/inventory/unidades");
  }, [makeRequest]);
  ...
  const getProductosInventario = useCallback(
    (categoria_id?: number): Promise<ProductoInventario[]> => {
      ...
      return makeRequest<ProductoInventario[]>(`/inventory/productos${query}`);
    },
    [makeRequest]
  );
  ...
  const createProductoInventario = useCallback(
    (data: CreateProductoInventarioData): Promise<ProductoInventario> => {
      return makeRequest<ProductoInventario>("/inventory/productos", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const updateProductoInventario = useCallback(
    (
      ...
      return makeRequest<ProductoInventario>(`/inventory/productos/${id}`, {
        method: "PUT",
        body: JSON.stringify(data),
      });
    },
  ...
  const getCompras = useCallback(
    (filters: GetComprasFilters = {}): Promise<Compra[]> => {
      ...
      if (filters.proveedor_id) {
        params.append("proveedor_id", filters.proveedor_id.toString());
      }
      if (filters.estado_compra) {
        params.append("estado_compra", filters.estado_compra);
      }
      if (filters.fechaInicio) {
        params.append("fechaInicio", filters.fechaInicio);
      }
      ...
      const queryString = params.toString();
      const endpoint = queryString ? `/inventory/compras?${queryString}` : "/inventory/compras";
  ...
  const getCompraById = useCallback(
    (id: number): Promise<Compra> => {
      return makeRequest<Compra>(`/inventory/compras/${id}`);
    },
    [makeRequest]
  );
  ...
  const createCompra = useCallback(
    (data: CreateCompraData): Promise<Compra> => {
      return makeRequest<Compra>("/inventory/compras", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const receiveCompra = useCallback(
    (id: number): Promise<{ message: string; }> => {
      return makeRequest<{ message: string }>(`/inventory/compras/${id}/receive`, {
        method: "POST",
      });
    },
    [makeRequest]
  ...
  const getCierresInventario = useCallback(
    (filters?: GetCierresFilters): Promise<CierreInventario[]> => {
      ...
      const queryString = params.toString();
      const endpoint = `/inventory/cierres${
  ...
  const getCierreById = useCallback(
    (id: number): Promise<CierreInventario> => {
      return makeRequest<CierreInventario>(`/inventory/cierres/${id}`);
    },
    [makeRequest]
  );
  ...
  const getCierreEstadisticas = useCallback(
    (id: number): Promise<CierreEstadisticas> => {
      return makeRequest<CierreEstadisticas>(
        `/inventory/cierres/${id}/estadisticas`
      );
    },
    [makeRequest]
  );
  ...
  const createCierreInventario = useCallback(
    (data: CreateCierreInventarioData): Promise<CierreInventario> => {
      return makeRequest<CierreInventario>("/inventory/cierres", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const finalizarCierre = useCallback(
    (id: number): Promise<{ message: string; cierre: CierreInventario }> => {
      return makeRequest<{ message: string; cierre: CierreInventario }>(
        `/inventory/cierres/${id}/finalizar`,
        {
          method: "POST",
        }
      );
  ...
  const getGastosOperativos = useCallback(
    (filters: GetGastosFilters = {}): Promise<GastoOperativo[]> => {
      ...
      const queryString = params.toString();
      const endpoint = queryString ? `/finance/gastos-operativos?${queryString}` : "/finance/gastos-operativos";
  ...
  const getGastoOperativoById = useCallback(
    (id: number): Promise<GastoOperativo> => {
      return makeRequest<GastoOperativo>(`/finance/gastos-operativos/${id}`);
    },
    [makeRequest]
  );
  ...
  const createGastoOperativo = useCallback(
    (data: CreateGastoOperativoData): Promise<GastoOperativo> => {
      return makeRequest<GastoOperativo>("/finance/gastos-operativos", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const deleteGastoOperativo = useCallback(
    (id: number): Promise<{ message: string }> => {
      return makeRequest<{ message: string }>(`/finance/gastos-operativos/${id}`, {
        method: "DELETE",
      });
    },
    [makeRequest]
  ...
  const getGastosEstadisticas = useCallback(
    (filters?: {
      ...
      const queryString = params.toString();
      const endpoint = `/finance/gastos-operativos/estadisticas/resumen${
        queryString ? `?${queryString}` : ""
      }`;
  ...
  const abrirCaja = useCallback(
    (data: AbrirCajaData): Promise<Caja> => {
      return makeRequest<Caja>("/finance/caja/abrir", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const getEstadoCaja = useCallback((): Promise<EstadoCajaResponse> => {
    return makeRequest<EstadoCajaResponse>("/finance/caja/estado");
  }, [makeRequest]);

  const registrarMovimientoCaja = useCallback(
    (data: RegistrarMovimientoData): Promise<{ message: string }> => {
      return makeRequest<{ message: string }>("/finance/caja/movimiento", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const cerrarCaja = useCallback(
    (data: CerrarCajaData): Promise<Caja> => {
      return makeRequest<Caja>("/finance/caja/cerrar", {
        method: "POST",
        body: JSON.stringify(data),
      });
    },
  ...
  const getResumenFinanciero = useCallback(async (fechaInicio?: string, fechaFin?: string) => {
    ...
    return makeRequest<any>(`/finance/finanzas/resumen?${params.toString()}`);
  }, [makeRequest]);

  const calcularPagoNomina = useCallback(async (empleadoId: number) => {
      return makeRequest<CalcularPagoResponse>(`/finance/nomina/calcular/${empleadoId}`);
  }, [makeRequest]);

  const pagarNomina = useCallback(async (empleadoId: number, data: PagarNominaData) => {
      return makeRequest<PagarNominaResponse>(`/finance/nomina/pagar/${empleadoId}`, {
          method: "POST",
          body: JSON.stringify(data),
      });
  }, [makeRequest]);
