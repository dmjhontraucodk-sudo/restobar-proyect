...
// Icono de check para confirmar (si lo necesitas)
...
// Icono adicional para estadísticas o información general
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 8.048M12 4.354a4 4 0 100 8.048m0-8.048L9.172 7.172a4 4 0 015.656 0M12 12.354a4 4 0 110 8.048m0-8.048l2.828 2.828a4 4 0 01-5.656 0M12 20.354a6 6 0 100-12 6 6 0 000 12z" />
  </svg>
);
