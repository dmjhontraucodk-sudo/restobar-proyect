// src/components/menu/ProductsTable.tsx
import React from 'react';
import { EditIcon, TrashIcon, EyeIcon, EyeOffIcon, ArchiveIcon, RotateCcwIcon } from '../icons';
    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      <table className="w-full">
        <thead className="bg-gray-50">
          <tr>
            <th className="py-4 px-6 text-left font-medium text-gray-600 text-sm uppercase tracking-wide border-b border-gray-200">
              Plato
            </th>
            <th className="py-4 px-6 text-left font-medium text-gray-600 text-sm uppercase tracking-wide hidden xl:table-cell border-b border-gray-200">
              Descripción
            </th>
            <th className="py-4 px-6 text-left font-medium text-gray-600 text-sm uppercase tracking-wide border-b border-gray-200">
              Precio
            ...
            <th className="py-4 px-6 text-right font-medium text-gray-600 text-sm uppercase tracking-wide border-b border-gray-200">
              Acciones
            </th>
          </tr>
        </thead>
              ...
              <td className="py-4 px-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`text-sm text-gray-500 truncate xl:hidden mt-1 ${
              ...
              <td className="py-4 px-6">
                <div className="flex flex-col space-y-2 text-sm">
                  ...
                  <span className={`inline-flex items-center ${
                    ...
                    {item.visible_en_web ? 'Visible en web' : 'Oculto en web'}
                  </span>
                </div>
              </td>
