// frontend/src/components/team/EmployeeTable.tsx
        ...
        <>
            ...
            {passwordModal.show && (
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="fixed inset-0 bg-black bg-opacity-50" onClick={() => setPasswordModal({ show: false, password: '' })} />
                    <div className="flex min-h-full items-center justify-center p-4">
                        <div className="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
                            ...
                            <p className="text-xs text-amber-600 mb-4">
                                ⚠️ Esta contraseña es temporal. El empleado deberá cambiarla en su primer inicio de sesión.
                            </p>
                            <button
